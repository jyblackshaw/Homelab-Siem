...
During the planning phase, I used Cisco Packet Tracer to prototype the network architecture. The design shown in the diagram below is the most up to date iteration.
